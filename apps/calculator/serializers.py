...
class CalculatorSerializer(serializers.ModelSerializer):
    ...
    uc1 = NormalDecimalField(max_digits=15, decimal_places=6, required=False, validators=[casi_positive_number])
    uc2 = NormalDecimalField(max_digits=15, decimal_places=6, required=False, validators=[casi_positive_number])
    uc3 = NormalDecimalField(max_digits=15, decimal_places=6, required=False, validators=[casi_positive_number])
    uc4 = NormalDecimalField(max_digits=15, decimal_places=6, required=False, validators=[casi_positive_number])
    uc5 = NormalDecimalField(max_digits=15, decimal_places=6, required=False, validators=[casi_positive_number])
    uc6 = NormalDecimalField(max_digits=15, decimal_places=6, required=False, validators=[casi_positive_number])
    up1 = NormalDecimalField(max_digits=15, decimal_places=6, required=False, validators=[casi_positive_number])
    up2 = NormalDecimalField(max_digits=15, decimal_places=6, required=False, validators=[casi_positive_number])
    up3 = NormalDecimalField(max_digits=15, decimal_places=6, required=False, validators=[casi_positive_number])
    up4 = NormalDecimalField(max_digits=15, decimal_places=6, required=False, validators=[casi_positive_number])
    up5 = NormalDecimalField(max_digits=15, decimal_places=6, required=False, validators=[casi_positive_number])
    up6 = NormalDecimalField(max_digits=15, decimal_places=6, required=False, validators=[casi_positive_number])
