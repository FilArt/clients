    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equip_rent_t20', models.FloatField(default=1, validators=[apps.calculator.fields.is_positive])),
                ('equip_rent_t20dha', models.FloatField(default=1, validators=[apps.calculator.fields.is_positive])),
                ('equip_rent_t20dhs', models.FloatField(default=1, validators=[apps.calculator.fields.is_positive])),
                ('equip_rent_t21', models.FloatField(default=1, validators=[apps.calculator.fields.is_positive])),
                ('equip_rent_t21dha', models.FloatField(default=1, validators=[apps.calculator.fields.is_positive])),
                ('equip_rent_t21dhs', models.FloatField(default=1, validators=[apps.calculator.fields.is_positive])),
                ('equip_rent_t30', models.FloatField(default=1, validators=[apps.calculator.fields.is_positive])),
                ('equip_rent_t31', models.FloatField(default=1, validators=[apps.calculator.fields.is_positive])),
            ],
        ),
        migrations.CreateModel(
            name='Company',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tarif', models.CharField(choices=[('2.0A', '2.0A'), ('2.0DHA', '2.0DHA'), ('2.0DHS', '2.0DHS'), ('2.1A', '2.1A'), ('2.1DHA', '2.1DHA'), ('2.1DHS', '2.1DHS'), ('3.0A', '3.0A'), ('3.1A', '3.1A')], max_length=10)),
                ...
                ('is_price_permanent', models.CharField(choices=[('Fijo', 'Fijo'), ('Indexado', 'Indexado')], max_length=20)),
