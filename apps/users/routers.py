...
user_router.register("notys", viewsets.NotificationViewSet)
user_router.register("groups", viewsets.GroupsViewSet)
user_router.register("new_client", viewsets.CreateClientViewSet)
