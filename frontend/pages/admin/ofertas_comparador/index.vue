  ...
  <v-card>
    ...
    <v-toolbar>
      ...
      <v-toolbar-items class="align-center">
        ...
        <v-btn nuxt to="/admin/ofertas_comparador/prioridad_de_ofertas" color="green">Prioridad de ofertas</v-btn>

        <v-btn nuxt to="/admin/ofertas_comparador/comercializadoras" color="warning">Comercializadoras</v-btn>

        <v-btn nuxt to="/admin/ofertas_comparador/update" color="success">
          <v-icon>mdi-plus-box-multiple</v-icon>
        </v-btn>

        <v-btn nuxt to="/admin/ofertas_comparador/nuevo_oferta" color="success">
...
export default {
  ...
  methods: {
    ...
    async refresh() {
      ...
      let getParamsString = fullPath.includes('?') ? fullPath.split('?')[1] : 'page=1&itemsPerPage=10&calculator=true'
      try {
